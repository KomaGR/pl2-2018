...
Να σημειώσουμε εδώ ότι το $\mathbb{A}$ αναπαριστά το}
disjoint sum \textgreek{των $\mathbb{N}$ και $\mathbb{T}$, και
επομένως κανονικά τα στοιχεία του θα ήταν της μορφής 
$(0, \mathrm{N})$ ή $(1, \mathrm{T})$, όπου
$\mathrm{N} \in \mathbb{N}, \mathrm{T} \in \mathbb{T}$.
Πάραυτα, δεν θα είμαστε τόσο σχολαστικοί στην σημιογραφία
τους παρακάτω.
